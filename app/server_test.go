...
func TestGame(t *testing.T) {
	...
	t.Run("start a game with 5 players and declare Junebug as the winner", func(t *testing.T) {
		...
		writeWSMessage(t, ws, "5")
		writeWSMessage(t, ws, winner)

		time.Sleep(sleepTime)
		assertGameStartedWith(t, game, 5)
		assertGameFinishCalledWith(t, game, winner)
		within(t, sleepTime, func() { assertWebsocketGotMSG(t, ws, wantedBlindAlert) })
	})
}
...
func assertStatus(t testing.TB, res *httptest.ResponseRecorder, want int) {
	t.Helper()
	if res.Code != want {
		t.Errorf("did not get correct status, got %d, want %d", res.Code, want)
	}
}
